defmodule Scrumpointer.Coherence.Schemas do
  use Coherence.Config

  import Ecto.Query

  # Scrumpointer.Coherence.User
  # |> Scrumpointer.Repo.get_by(email: "lasslo.net@gmail.com")
  # |> Ecto.Changeset.change(%{admin: true})
  # |> Coherence.Config.repo().update()
  ...
  Enum.each([Scrumpointer.Coherence.Invitation], fn module ->
    name =
      module
      |> Module.split()
      |> List.last()
